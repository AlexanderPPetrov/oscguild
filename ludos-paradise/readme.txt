...
WordPress version: required at least 4.5, tested up to 4.9.4
...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Game Paradise'.
Please install and activate it before starting to use the theme Game Paradise.
...
Theme documentation is available on http://game-paradise.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Game Paradise is Fontello.
